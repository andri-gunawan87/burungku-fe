    ...
    <v-card light class="ma-2">
      <v-list-item>
        ...
        <v-list-item-content>
          ...
          <v-list-item-subtitle>{{ data.jadwal }}</v-list-item-subtitle>
          <v-list-item-subtitle>{{ data.lokasi_id }}</v-list-item-subtitle>
          <v-list-item-subtitle>{{ data.harga_tiket }}</v-list-item-subtitle>
        </v-list-item-content>
      </v-list-item>
